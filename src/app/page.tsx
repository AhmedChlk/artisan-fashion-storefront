        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-8">
          ...
          <div className="col-span-1 md:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-gutter">
            ...
            <Link className="group block" href="/boutique/chemise-lin-naturel">
              ...
              <div>
                <h3 className="font-headline-lg text-headline-lg text-on-surface text-xl mb-2">
                  Chemise et Pantalon
                </h3>
                <p className="font-body-lg text-body-lg text-on-surface-variant text-sm">
                  Coton et laine
                </p>
                <span className="font-label-md text-label-md text-primary mt-2 block">
                  €280
                </span>
              </div>
            </Link>
